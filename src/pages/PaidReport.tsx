...
// Build the hero visual HTML — uses real Pexels image if available
function buildHeroVisualHtml(pexelsImageUrl?: string | null): string {
  ...
  // Fallback — clean placeholder, no dark ugly box
  return `
...
// Inject our hero visual into the mockup HTML wherever HERO_VISUAL_SLOT appears
function injectHeroVisualSlot(
  ...
  // Simple string replace first — handles most cases
...
export default function PaidReport() {
  ...
  // Screenshot URL via thum.io — used for Before tab
...
3. Share the HTML, PNG, and implementation notes with your developer or designer.
