    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-lg prose-slate max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-slate-600 mb-3">ConversionDoc provides:</p>
          <ul className="list-disc pl-6 text-slate-600 space-y-2">
            <li>
              <strong>Free Audit:</strong> Landing page analysis with conversion 
              score and top 3 fixes
            </li>
            <li>
              <strong>Full Diagnosis (£149 one-time):</strong> Complete analysis, 
              rewritten copy, visual mockup, and downloadable code
            </li>
            <li>
              <strong>Starter Pro (£99/month):</strong> 20 full audits per month 
              with priority support
            </li>
            <li>
              <strong>Agency Pro (£199/month):</strong> Unlimited audits for 
