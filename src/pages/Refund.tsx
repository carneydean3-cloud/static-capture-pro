          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-slate-700 space-y-2">
                <li>
                  <strong className="text-slate-900">Full Diagnosis (£149):</strong> Eligible for full
                  refund within 5 days of purchase
                </li>
                <li>
                  <strong className="text-slate-900">Starter Pro (£99/month):</strong> Eligible for refund
                  within 5 days of initial purchase only. Renewal charges are non-refundable
                </li>
                <li>
                  <strong className="text-slate-900">Agency Pro (£199/month):</strong> Eligible for refund
                  within 5 days of initial purchase only. Renewal charges are non-refundable
                </li>
                <li>
                  <strong className="text-slate-900">Free Audit:</strong> No charge, no refund applicable
                </li>
              </ul>
            </section>
