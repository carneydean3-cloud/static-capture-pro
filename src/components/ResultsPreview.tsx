...
const ResultsPreview = () => {
  ...
  const pillars = [
    { pillar: "Clarity", score: result.scores?.clarity?.score || 0 },
    { pillar: "Hook", score: result.scores?.hook?.score || 0 },
    { pillar: "Trust", score: result.scores?.trust?.score || 0 },
    { pillar: "Desire", score: result.scores?.desire?.score || 0 },
    { pillar: "Action", score: result.scores?.action?.score || 0 },
    { pillar: "Objections", score: result.scores?.objections?.score || 0 },
  ];
