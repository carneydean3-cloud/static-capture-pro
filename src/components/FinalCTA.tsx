      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            {isGeoMode
              ? "Is AI search sending traffic to your competitors instead?"
          ...
          <p className="text-xl text-muted-foreground mb-6 max-w-2xl mx-auto">
            {isGeoMode
              ? "Every day without a GEO audit is another day ChatGPT, Perplexity, and Google AI Overviews are recommending someone else. Find out where you stand in 60 seconds."
